...
/*   Updated: 2020/02/12 19:18:14 by blorin      ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
int					check_color_sol(char *line, t_storage *ptr,
					t_check *checkv);
int					check_color_plaf(char *line, t_storage *ptr,
					t_check *checkv);
...
int					*draw_wall(t_storage *ptr, int start, int lineheight,
					int *img);
int					*put_pixel(t_storage *ptr, int start, int lineheight,
					int *img);
